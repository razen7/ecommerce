        ...
        <>
            <header className='md:border-b-2 md:pb-5'>
                <div className="header-top flex justify-between h-6 mt-1">
                    ...
                    <img src="https://bigpasal.com/wp-content/uploads/2021/06/sadUntitled-1.png" alt="bigpasal" />
                    ...
                    <div className='relative'>
                        ...
                        <div className='absolute right-0 top-3' onClick={() => setShowMCart(!showMCart)}>
                            <BsFillCartFill />
                        </div>
                    </div>
                </div>
            ...
            <div className={`${showMCart ? '' : 'opacity-0'} transition-all duration-300 ease-in`}>
                <Minicart />
            </div>
        </>
